...
const FeedbackDetailPage = lazy(() => import('./FeedbackDetailPage.jsx'))
  ...
  <StrictMode>
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route path="/club/:teamId/feedback/:feedbackId" element={<RequireAuth><FeedbackDetailPage /></RequireAuth>} />
