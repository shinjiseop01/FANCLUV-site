// FANCLUV Admin Console — mock seed data + menu config.
// 여기 정의된 MOCK_* 상수는 각 관리 페이지(회원/의견/설문/뉴스/신고)의 Mock 폴백 시드다.
// 대시보드 집계(KPI·구단별·최근활동·차트)는 별도 서비스 src/lib/admin/adminStats.js 로
// 분리되어 있고, Supabase 설정 시 실제 집계(RPC)로 동작한다.
...
// ── Members ──
// provider(로그인 방식) / gender / ageGroup / lastActiveAt 는 운영자 회원 상세에서만 노출.
export const MOCK_MEMBERS = [
  { id: 'm1', nickname: '민준',       email: 'fan@fancluv.kr',      joinedAt: '2025-03-14', team: 'seoul',    status: 'active', role: ROLES.FAN, verificationStatus: 'email_verified', identityVerified: true,  provider: 'email',  gender: 'male',   ageGroup: '20',  lastActiveAt: '2026-07-05' },
  { id: 'm2', nickname: '블루윙',     email: 'bluewing@example.com', joinedAt: '2026-06-30', team: 'ulsan',    status: 'active', role: ROLES.FAN, verificationStatus: 'phone_verified', identityVerified: true,  provider: 'google', gender: 'female', ageGroup: '30',  lastActiveAt: '2026-07-04' },
  { id: 'm3', nickname: '직관러',     email: 'gozip@example.com',    joinedAt: '2026-06-30', team: 'jeonbuk',  status: 'active', role: ROLES.FAN, verificationStatus: 'email_verified', identityVerified: false, provider: 'kakao',  gender: 'male',   ageGroup: '20',  lastActiveAt: '2026-07-05' },
  { id: 'm4', nickname: '시즌권홀더', email: 'season@example.com',   joinedAt: '2026-06-12', team: 'pohang',   status: 'active', role: ROLES.FAN, verificationStatus: 'unverified',      identityVerified: false, provider: 'email',  gender: 'male',   ageGroup: '40',  lastActiveAt: '2026-06-28' },
  { id: 'm5', nickname: '굿즈수집가', email: 'goods@example.com',    joinedAt: '2026-05-28', team: 'daejeon',  status: 'inactive', role: ROLES.FAN, verificationStatus: 'unverified',    identityVerified: false, provider: 'naver',  gender: 'female', ageGroup: '20',  lastActiveAt: '2026-06-10' },
  { id: 'm6', nickname: '응원단장',   email: 'leader@example.com',   joinedAt: '2026-05-19', team: 'gwangju',  status: 'active', role: ROLES.FAN, verificationStatus: 'email_verified', identityVerified: true,  provider: 'email',  gender: 'male',   ageGroup: '50+', lastActiveAt: '2026-07-03' },
  { id: 'm7', nickname: '풋볼러버',   email: 'footlover@example.com', joinedAt: '2026-04-30', team: 'gangwon',  status: 'active', role: ROLES.FAN, verificationStatus: 'phone_verified', identityVerified: true,  provider: 'kakao',  gender: 'female', ageGroup: '30',  lastActiveAt: '2026-07-05' },
  { id: 'm8', nickname: '평일직관',   email: 'weekday@example.com',  joinedAt: '2026-04-11', team: 'jeju',     status: 'active', role: ROLES.FAN, verificationStatus: 'email_verified', identityVerified: true,  provider: 'google', gender: 'male',   ageGroup: '40',  lastActiveAt: '2026-07-01' },
  { id: 'm9', nickname: '레전드7',    email: 'legend7@example.com',  joinedAt: '2026-03-22', team: 'incheon',  status: 'active', role: ROLES.FAN, verificationStatus: 'unverified',      identityVerified: false, provider: 'email',  gender: 'female', ageGroup: '10',  lastActiveAt: '2026-06-20' },
]
